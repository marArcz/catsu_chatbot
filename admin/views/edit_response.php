...
<head>
    ...
    <title>Edit Response | Admin</title>
...
<body class="bg-light">
    ...
    <main id="main" class="<?= Session::hasSession("closed_sidebar") ? 'expanded':'' ?>">
        <?php $header_title = 'Edit Response'; ?>
                            ...
                            <div class="card-body p-4">
                                <div class="mb-3">
                                    ...
                                    <select required name="response_type" id="response-type" class="form-select">
                                        <option value="2" <?= $response['response_type'] == 'Message' ? 'selected' : '' ?>>Message</option>
                                        <option value="1" <?= $response['response_type'] == 'Action' ? 'selected' : '' ?>>Action</option>
                                    </select>
                                </div>
                                                ...
                                                <div class="row gx-0 keyword-row-item">
                                                    <div class="col">
                                                        <div class="border p-2">
                                                            <input type="text" value="<?= $query['keyword'] ?>" class="form-control" required name="keywords[]">
                                                        </div>
                                                    </div>
                                    ...
                                    <div id="suggestions-container">
                                        ...
                                        ?>
                                            <div class="row gx-0 suggestion-row-item">
                                                <div class="col">
                                                    <div class="border p-2">
                                                        <input type="text" value="<?= $row['keyword'] ?>" class="form-control" name="suggestions[]">
                                                    </div>
                                                </div>
                                                <div class="col-lg-2 col-sm-auto col-3">
                                                    <div class="border p-2">
